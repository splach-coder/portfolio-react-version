...
const getResume = () => {
  return (
    <div className="con">
      <section className="bg-section min-h-screen ms-[20px]">
        <div className="flex flex-col items-center mx-auto gap-7 py-[90px] bg-black">
          ...
          <div className="text-[16px] md:text-desc text-yellow md:leading-[16px] leading-[20px] text-center max-w-[350px] md:max-w-3xl">
      ...
      <section className="mt-[150px] bg-black">
        <SectionHeader
          icon="{#}"
          title="&lt;experience&gt;"
        ...
        <div className="grid grid-cols-12 w-full mt-[50px]">
          {experiences.map((service) => (
            <div
              ...
              <div className="col-span-12 md:col-span-5 flex flex-col gap-3 text-left p-[20px] md:p-[50px]">
